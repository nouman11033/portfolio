  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="relative">
        <div className="inline-flex items-center rounded-full border border-[#E5E5E9] bg-[#ECECF0] py-2 pr-2 pl-6">
          <input
            ref={inputRef}
            type="text"
            value={input}
            ...
            className="text-md min-w-[620px] border-none bg-transparent text-black placeholder:text-gray-500 focus:outline-none"
